...
*Revision: first issue, 2026-09-04; amended 2026-09-11 (added rules 9–10: per-project tmux launch, and the org-root read-block that stalls unattended children). Amend by appending a dated revision; do not silently overwrite.*
